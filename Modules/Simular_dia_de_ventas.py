...
class SimuladorDia:
    ...
    def simular_dia(self):
        ...
        #cual fue el promedio de hot dogs por cliente
        ...
        #cual fue el hot dog más vendido
        ...
        #cuantos acompañantes fueron vendidos
        print(f"● Acompañantes (adicionales) vendidos: {self.acompanantes_vendidos_total}")

        print("\n--- Detalles de Fallos de Stock ---")
        
        #cuales fueron los hot dogs que causaron que el cliente se marchara
        ...
        #cuales fueron los ingredientes que causaron que el cliente se marchara
